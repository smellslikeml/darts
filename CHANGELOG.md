...
- 🚀🚀 Added new forecasting model `XPatchModel` : a dual-stream architecture with exponential (EMA / DEMA) seasonal-trend decomposition that processes the seasonal component with a patch-based CNN stream and the trend component with a linear MLP stream. It supports past covariates (as additional channel-independent input features) and probabilistic forecasting. [xPatch paper](https://arxiv.org/abs/2412.17323) ([reference implementation](https://github.com/stitsyuk/xPatch), Apache-2.0). [#XXXX](https://github.com/unit8co/darts/pull/XXXX) by [smellslikeml](https://github.com/smellslikeml).
